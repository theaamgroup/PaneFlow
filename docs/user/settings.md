...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| General            | Default external editor (file links and Open in editor) and default shell for new terminal panes.                                                    | `external_editor`, `default_shell`                                                                                                                                                                          | New launches. Running terminals keep their current process.                 |
...
| AI Agent           | Launcher button visibility, Claude Code bypass mode, and AI free access.                                                                             | `*_button_visible`, `claude_code_bypass_permissions`, `ai_unrestricted`                                                                                                                                     | Launcher and access changes hot-reload.                                     |
