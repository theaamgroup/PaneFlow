...
//!
//! Two scrollbar systems share `scrollbar::geometry` for the thumb math:
...
//! the Changes dock (#434). After #435 the file editor paints Zed-style tracks
//! through `diff_dock::code::navigation` using the same geometry.
