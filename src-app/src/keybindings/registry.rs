...
use crate::{
    ...
    NewWorkspace, NextTab, NextWorkspace, OpenWorkspaceInEditor, PreviousTab, Quit, ResetTerminal,
...
pub(super) const ACTIONS: &[ActionMeta] = &[
    ...
    ActionMeta {
        name: "open_workspace_in_editor",
        factory: || Box::new(OpenWorkspaceInEditor),
        context: "",
